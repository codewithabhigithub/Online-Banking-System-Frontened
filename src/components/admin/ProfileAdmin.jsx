...
function ProfileAdmin() {
  ...
  useEffect(() => {
    axios.get("http://localhost:8888/admin/profile", {
      headers: {
              ...
              <Grid container spacing={3} alignItems="center" justify="center">
                ...
                <Grid item>
                  <p className="text-muted mb-1">
                    <h1 align="center" style={ { fontFamily : 'LatoBold',fontWeight:'bold' } } >Admin Data</h1>
                  </p>
                  {/* <p className="text-muted mb-4" align="center">Apna Bank</p> */}
                </Grid>
              </Grid>
            </Paper>
          </Grid>
                  ...
                  <TableHead>
                    <TableRow>
                      <TableCell colSpan={2} align="center">
                        <h1 className="profile-heading" style={ { fontFamily : 'LatoBold',fontWeight:'bold' } } >Official Details</h1>
                      </TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
