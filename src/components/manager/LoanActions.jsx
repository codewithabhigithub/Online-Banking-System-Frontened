...
export default function LoanAction(props) {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8888/transactionByManager/accountDetails/findAll/" + application.cif, {
            headers: {
    ...
    const handleReject = () => {
        axios.delete("http://localhost:8888/managerLoan/reject/" + application.id, {
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${jwt}`,
            },
    ...
    const handleApproval = () => {
        ...
        axios.
            get("http://localhost:8888/managerLoan/sanction/" + application.id + "/" + amount + "/" + account.accountNumber, {
                headers: {
                    // "Content-Type": "application/json",
                    Authorization: `Bearer ${jwt}`,
                },
                                                ...
                                                <TableHead>
                                                    <TableRow>
                                                        <TableCell colSpan={2} align="center">
                                                            <h1 className="profile-heading">Loan Details</h1>
                                                        </TableCell>
                                                    </TableRow>
                                                </TableHead>
                                                <TableBody>
