...
export default function CreditCardAction(props) {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8888/creditCard/manager/find/" + application.cif, {
            headers: {
    ...
    const handleReject = () => {
        axios.delete("http://localhost:8888/creditCard/manager/remove/" + application.cif, {
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${jwt}`,
            },
    ...
    const handleApproval = () => {
        ...
        axios.
            get("http://localhost:8888/creditCard/manager/approve/" + application.cif, {
                headers: {
                    // "Content-Type": "application/json",
                    Authorization: `Bearer ${jwt}`,
                },
